                ...
                if self.received_items:
                    for received in self.received_items:
                        if received.get('item_index') == idx:
                            ...
                            break
                item_copy['od_received_quantity'] = received_qty
                item_copy['remaining_to_receive'] = item.get('quantity', 0) - received_qty
                item_copy['ordered_quantity'] = item.get('quantity', 0)
